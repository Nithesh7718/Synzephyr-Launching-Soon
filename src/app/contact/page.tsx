                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground">+91 94434 49557</p>
                                    </div>
                                </div>
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground">contact@synzephyr.web.app</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-12 p-6 bg-primary/5 rounded-2xl border border-primary/10">
                                ...
                                <p className="text-muted-foreground">
                                    We proudly serve businesses in Pollachi, Coimbatore, Udumalpet, Tirurpur, and surrounding areas in Tamil Nadu. We also work with clients globally.
                                </p>
                            </div>
                        </div>
